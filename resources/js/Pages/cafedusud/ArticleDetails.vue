<template>
    <UserLayout>
        ...
        <div class="lg:w-7/12 mx-auto mt-16 flex-col relative z-40 after:bg-orange-2 after:rounded-lg lg:after:absolute after:w-full after:h-full after:top-6 after:left-6 after:-z-50">
            ...
            <div class="flex-col relative text-center">
                ...
                <div class="flex justify-center">
                    ...
                    <p v-if="article.type === 'blog'"
                        class="font-abeezee text-blanc-1 bottom-0 absolute bg-rouge-2 rounded-t-lg rounded-tl-lg px-6 py-2">
                        Billet de blog
                    </p>
