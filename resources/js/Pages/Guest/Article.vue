...
<GuestLayout :title="article.title">
    ...
    <!-- Bouton retour -->
    <button class="flex group fixed top-24 left-8 z-50 bg-violet-4 text-blanc-1 py-2 px-4 rounded-xl hover:bg-violet-1"
        @click="back">
        <!-- Icône retour -->
                ...
                <div class="mx-auto max-w-2xl pb-24 pt-16 sm:pb-32 sm:pt-20 lg:ml-8 lg:mr-0 lg:w-full lg:max-w-lg lg:flex-none lg:pt-32 xl:w-1/2">
                    <div class="">
                        <ul class="flex flex-wrap gap-2 mb-8">
                            <li v-for="tag in article.tags" class="bg-bleu-1 px-2 py-1 rounded-md text-gray-800">
                                {{ tag.name }}
                            </li>
                        </ul>
                    </div>
                    <div class="shadow-2xl">
                        ...
                        <div :class="[
                            ...
                            <p class="mt-6 font-abeezee leading-relaxed text-gray-800 whitespace-pre-line">{{
                                article.content }}</p>
                        </div>
